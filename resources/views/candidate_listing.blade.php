...
<head>
    ...
    <!--srart theme style -->
    <link rel="stylesheet" type="text/css" href="{{URL::asset('css/animat.css')}}" />
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 hidden-sm hidden-xs">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 jp_cl_right_bar">
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                             <div class="jp_recent_resume_box_wrapper">
                                <div class="jp_recent_resume_img_wrapper">
                                   <img src="{{URL::asset('images/content/resume_img1.jpg')}}" alt="resume_img" />
                               </div>
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                         <div class="jp_recent_resume_box_wrapper">
                            <div class="jp_recent_resume_img_wrapper">
                               <img src="{{URL::asset('images/content/resume_img2.jpg')}}" alt="resume_img" />
                           </div>
                           <div class="jp_recent_resume_cont_wrapper">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="jp_recent_resume_box_wrapper">
                        <div class="jp_recent_resume_img_wrapper">
                           <img src="{{URL::asset('images/content/resume_img3.jpg')}}" alt="resume_img" />
                       </div>
                       <div class="jp_recent_resume_cont_wrapper">
                           <h3>Merry Foster</h3>
                           <p><i class="fa fa-folder-open-o"></i> <a href="#">UI Designer</a></p>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                 <div class="jp_recent_resume_box_wrapper">
                    <div class="jp_recent_resume_img_wrapper">
                        <img src="{{URL::asset('images/content/resume_img4.jpg')}}" alt="resume_img" />
                   </div>
                   <div class="jp_recent_resume_cont_wrapper">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
             <div class="jp_recent_resume_box_wrapper">
                <div class="jp_recent_resume_img_wrapper">
                   <img src="{{URL::asset('images/content/resume_img5.jpg')}}" alt="resume_img" />
               </div>
               <div class="jp_recent_resume_cont_wrapper">
                   <h3>Farhan Shaikh</h3>
                   <p><i class="fa fa-folder-open-o"></i> <a href="#">UI Designer</a></p>
