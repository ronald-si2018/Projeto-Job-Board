            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="jp_listing_heading_wrapper">
                        <h2>Nós achamos <span>357</span> Jogos para você.</h2>
                    </div>
                </div>
                                        ...
                                        <div class="content">
                                            <div class="box">
                                                <p>
                                                    ...
                                                    <label for="c33">Tipos  <span>(214)</span></label>

                                                    <p>
                                                        <input type="checkbox" id="c34" name="cb">
                                                        <label for="c34">Meio período <span>(514)</span></label>
                                                    </p>
                                                    <p>
                                                        <input type="checkbox" id="c35" name="cb">
                                                        <label for="c35">Contrato <span>(554)</span></label>
                                                    </p>
                                                    <p>
                                                        <input type="checkbox" id="c36" name="cb">
                                                        <label for="c36">Remotamente  <span>(457)</span></label>
                                                    </p>
                                                    <p>
                                                        <input type="checkbox" id="c37" name="cb">
                                                        <label for="c37">Temporário  <span>(1254)</span></label>
                                                    </p>
                                            </div>
                                        </div>
                                        <ul>
                                            <li><i class="fa fa-plus-circle"></i> <a href="#">Mostra mais</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                    <div class="gc_causes_search_box_wrapper gc_causes_search_box_wrapper2">
                                        <div class="gc_causes_search_box">
                                            <p>Você está assistindo &nbsp;<span>01 to 20</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
