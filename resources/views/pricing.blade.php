...
<head>
    ...
    <meta nome="description" content="Job Pro" />
    <meta nome="keywords" content="Job Pro" />
    <meta nome="author" content="" />
    <meta nome="MobileOptimized" content="320" />
    <!--srart theme style -->
    ...
    <!-- favicon links -->
    <link rel="shortcut icon" type="image/png" href="{{URL::asset('assets/images/header/favicon.ico')}}" />
</head>
...
CRIE A SUA CONTA</a></li>
                                <li><a href="login.html"><i class="fa fa-sign-in"></i>&nbsp; ENTRE</a></li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 hidden-sm hidden-xs">
                        <div class="jp_navi_right_btn_wrapper">
                            <ul>
                                <li><a href="add_postin.html"><i class="fa fa-plus-circle"></i>&nbsp; </a></li>
                            </ul>
                        </div>
                    </div>
                </div>
