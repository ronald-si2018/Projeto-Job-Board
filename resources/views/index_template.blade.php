...
<head>
	...
	<meta name="description" content="Trampe Aqui" />
	<meta name="keywords" content="Trampe Aqui" />
					...
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 hidden-xs hidden-sm full_width">
							<div class="gc_header_wrapper">
								<div class="gc_logo">
									<a href="index"><img src="{{URL::asset('images/header/logo.png')}}" alt="Logo" title="Trampe Aqui" class="img-responsive"></a>
								</div>
							</div>
						</div>
											...
											<div class="col-xs-6 col-sm-6">
												<div class="cd-dropdown-wrapper">
													...
													<nav class="cd-dropdown">
														<h2><a href="#">Trampe<span>Aqui</span></a></h2>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="jp_footer_logo_wrapper">
							<div class="jp_footer_logo">
								<a href="javascript:" id="return-to-top2"><img src="{{URL::asset('images/header/logo.png')}}" alt="footer_logo"/></a>
							</div>
						</div>
					</div>
							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<div class="jp_bottom_footer_left_cont">
										<p>© 2018 Trampe Aqui. All Rights Reserved.</p>
									</div>
