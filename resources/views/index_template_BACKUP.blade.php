								...
								<div class="mainmenu">
									...
									<ul class="float_left">
										<li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">  Home&nbsp;<i class="fa fa-angle-down"></i></a>
											<!-- mega menu start -->
											<ul>
												<li class="parent"><a href="index">Home1</a></li>
												<li class="parent"><a href="#">Home2</a></li>
												<li class="parent"><a href="#">Home3</a></li>
											</ul>
										</li>
										<li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">  Job&nbsp;<i class="fa fa-angle-down"></i></a>
											<!-- mega menu start -->
											<ul>
												<li class="parent"><a href="listing_left">Listing-Left</a></li>
												<li class="parent"><a href="listing_right">Listing-Right</a></li>
												<li class="parent"><a href="listing_single">listing_single</a></li>
										...
										<li class="parent gc_main_navigation"><a href="#" class="gc_main_navigation">candidates &nbsp;<i class="fa fa-angle-down"></i></a>
											<!-- sub menu start -->
											<ul>
												<li class="parent"><a href="company_listing">Company-Listing</a></li>
												<li class="parent"><a href="company_listing_single">Company-Single</a></li>
												<li class="parent"><a href="candidate_listing">candidate-Listing</a></li>
												<li class="parent"><a href="candidate_profile">candidate-Profile</a></li>
										...
										<li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">  Pages&nbsp;<i class="fa fa-angle-down"></i></a>
											<!-- mega menu start -->
											<ul>
												<li class="parent"><a href="about">About-Us</a></li>
												<li class="parent"><a href="404error">404</a></li>
												<li class="parent"><a href="add_postin">Add-Posting</a></li>
												<li class="parent"><a href="login">Login</a></li>
												<li class="parent"><a href="register">Register</a></li>
												<li class="parent"><a href="pricing">Pricing</a></li>
											</ul>
										</li>
										<li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">  Blog&nbsp;<i class="fa fa-angle-down"></i></a>
											<!-- mega menu start -->
											<ul>
												<li class="parent"><a href="blog_left">Blog-Left</a></li>
												<li class="parent"><a href="blog_right">Blog-Right</a></li>
												<li class="parent"><a href="blog_single_left">Blog-Single-Left</a></li>
												<li class="parent"><a href="blog_single_right">Blog-Single-Right</a></li>
														...
														<ul class="cd-dropdown-content">
															...
															<li class="has-children">
																...
																<ul class="cd-secondary-dropdown is-hidden">
																	<li class="go-back"><a href="#0">Menu</a></li>
																	<li>
																		<a href="listing_left">Listing-Left</a>
																	</li>
																	<!-- .has-children -->

																	<li>
																		<a href="listing_right">Listing-Right</a>
																	</li>
																	<!-- .has-children -->

																	<li>
																		<a href="listing_single">Listing-Single</a>
																	</li>
																	<!-- .has-children -->
															...
															<li class="has-children">
																...
																<ul class="cd-secondary-dropdown is-hidden">
																	<li class="go-back"><a href="#0">Menu</a></li>
																	<li><a href="company_listing">Company-Listing</a></li>
																	<li><a href="company_listing_single">Company-Single</a></li>
																	<li><a href="candidate_listing">candidate-Listing</a></li>
																	<li><a href="candidate_profile">candidate-Profile</a></li>
																	<!-- .has-children -->
															...
															<li class="has-children">
																...
																<ul class="cd-secondary-dropdown is-hidden">
																	...
																	<li><a href="add_postin">Add-Posting</a></li>
															...
															<li class="has-children">
																...
																<ul class="cd-secondary-dropdown is-hidden">
																	<li class="go-back"><a href="#0">Menu</a></li>
																	<li>
																		<a href="blog_left">Blog-Left</a>
																	</li>
																	<!-- .has-children -->

																	<li>
																		<a href="blog_right">Blog-Right</a>
																	</li>
																	<!-- .has-children -->

																	<li>
																		<a href="blog_single_left">Blog-Single-Left</a>
																	</li>
																	<!-- .has-children -->

																	<li>
																		<a href="blog_single_right">Blog-Single-Left</a>
																	</li>
																	<!-- .has-children -->
							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<div class="jp_bottom_footer_left_cont">
										<p>© 2018 Desenvolvido durante uma disciplina na Metropolitana</p>
									</div>
