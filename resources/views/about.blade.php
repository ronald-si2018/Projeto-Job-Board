            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                    <div class="about_image_wrapper">
                        <img class="img-responsive" src="{{URL::asset('images/content/register_bg.jpg')}}" alt="about-img">
                    </div>
                </div>
                            ...
                            <div class="owl-carousel owl-theme">
                                <div class="item jp_recent_main">
                                    ...
                                    <div class="jp_career_slider_bottom_cont">
                                        <ul>
                                            <li><img src="{{URL::asset('images/content/blog_small_img.jpg')}}" alt="small_img" class="img-circle">&nbsp;&nbsp; <a href="#">Jhon Doe</a></li>
                                        </ul>
