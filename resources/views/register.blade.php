                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div role="tabpanel">
                            ...
                            <ul id="tabOne" class="nav register-tabs">
                                <li class="active"><a href="#contentOne-1" data-toggle="tab">Conta pessoal <br> <span>Estou procurando um emprego</span></a>
                                </li>
                                <li><a href="#contentOne-2" data-toggle="tab">conta empresarial<br> <span>Estamos contratando funcionarios</span></a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade in active register_left_form" id="contentOne-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <input type="text" name="field-name" value="" placeholder="localização atual">
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="check-box text-center">
                                                ...
                                                <label for="account-option_1">Eu concordo com os <a href="#" class="check_box_anchr">Termos e Condições</a> governando o uso do emprego</label>
                                            </div>
                                        </div>
                                    </div>
